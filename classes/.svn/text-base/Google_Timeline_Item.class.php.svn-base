...
class Google_Timeline_Item {
        ...
        // this will be converted to the JSON you saw above
                ...
                if ($this->attachments) foreach ($this->attachments as $attachment) {
                        $postData['attachments'][] = $attachment->toJSONObject();                        
                }
        ...
        public function insert() {
                ...
                $this->HttpPost = new HttpPost(self::URL.'?uploadType=multipart');
                $this->HttpPost->setHeaders( $headers );
                $this->HttpPost->setRawPostData( $jsonPost );
		...
		public function get($id) {
                ...
                $this->HttpPost = new HttpPost(self::URL.'/'.$id);
                $this->HttpPost->setHeaders( $headers );
